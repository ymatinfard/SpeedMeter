...
@Suppress("EnumEntryName")
enum class SpeedMeterFlavor(val dimension: FlavorDimension, val applicationIdSuffix: String? = null) {
...
fun configureFlavors(
    ...
    flavorConfigurationBlock: ProductFlavor.(flavor: SpeedMeterFlavor) -> Unit = {},
) {
    commonExtension.apply {
        ...
        productFlavors {
            SpeedMeterFlavor.values().forEach { niaFlavor ->
