...
class StopWatchDaoTest {
    ...
    @Test
    fun getPlayerWithSessionsAndLaps_whenDataExists_returnsPlayerWithRelations() = runTest {
        val player = PlayerEntity(id = 123, fullName = "Mr Yousef Matinfard", imageUrl = "")
        val session = SessionEntity(id = 1, playerId = 123, distance = 12f)
        val laps = listOf(TimeLapEntity(id = 1, sessionId = 1, lapTime = 1000L, totalTime = 2000L, lapNumber = 1, playerId = 123))

        stopWatchDao.insertPlayer(player)
        stopWatchDao.insertSession(session)
        stopWatchDao.insertLaps(laps)

        val result = stopWatchDao.getPlayerWithSessionsAndLaps(123)
    ...
    fun getAllPlayersWithSessionsAndLaps_whenDataExists_returnsPlayersWithRelations() = runTest {
        ...
        val session1 = SessionEntity(id = 1, playerId = 1, distance = 20f)
        val session2 = SessionEntity(id = 2, playerId = 2, distance = 30f)
        val laps1 = listOf(TimeLapEntity(id = 1, sessionId = 1, lapTime = 1000, totalTime = 2000, lapNumber = 1, playerId = 1))
        val laps2 = listOf(TimeLapEntity(id = 2, sessionId = 2, lapTime = 2000, totalTime = 4000, lapNumber = 1, playerId = 2))
    ...
    fun deletePlayerById_whenPlayerHasSessionsAndLaps_associatedDataIsDeleted() = runTest {
        val player = PlayerEntity(id = 123, fullName = "Mr Yousef Matinfard", imageUrl = "")
        val session = SessionEntity(id = 1, playerId = 123, distance = 12f)
        val laps = listOf(TimeLapEntity(id = 1, sessionId = 1, lapTime = 1000, totalTime = 2000, lapNumber = 1, playerId = 123))
        ...
        val retrievedSession = stopWatchDao.getPlayerWithSessionsAndLaps(123)
